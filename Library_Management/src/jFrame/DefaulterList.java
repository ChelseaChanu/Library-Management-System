...
public class DefaulterList extends JFrame {
	...
	public DefaulterList() {
		...
		JLabel lblNewLabel_2_2 = new JLabel("Defaulter List");
		lblNewLabel_2_2.setIcon(new ImageIcon(DefaulterList.class.getResource("/AddNewBookIcons/AddNewBookIcons/icons8_Edit_Property_50px.png")));
		...
		lblNewLabel.setIcon(new ImageIcon(DefaulterList.class.getResource("/AddNewBookIcons/AddNewBookIcons/icons8_Rewind_48px.png")));
